            ...
            <ul>
              ...
              <div className="header__social">
                <p className="header__linkedin">
                  <a href="https://www.linkedin.com/in/abdulrehman-siddiqui-0b250b264/" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faLinkedin} size="2x" /></a>
                </p>

                <p className='header__github'>
                  <a href="https://github.com/Siddiquiweb" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faGithub} size="2x" /></a>
                </p>

                <p className='header__youtube'>
                  <a href="https://www.instagram.com/abdulrehmansid7/profilecard/?igsh=MXRubDdrZnh2ZXlneQ==" rel="noopener noreferrer" target="_blank"><FontAwesomeIcon icon={faInstagram} size="2x" /></a>
                </p>
              </div>
            </ul>
          </div>
